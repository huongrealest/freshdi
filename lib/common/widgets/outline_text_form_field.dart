        ...
        super(
            ...
            builder: (FormFieldState<String> field) {
              ...
              final InputDecoration effectiveDecoration = (decoration ??
                      (multiline
                          ? AppFormField.multilineInputDecoration
                          : AppFormField.inputDecoration))
...
class _OutlineTextFormFieldState extends FormFieldState<String> {
  ...
  void initState() {
    ...
    if (widget.controller == null) {
      _controller =
          TextEditingController(text: widget.initialValue ?? widget.data.value);
    }
    setValue(widget.initialValue ?? widget.data.value);
    _effectiveController.addListener(_handleControllerChanged);
    dataStreamSubscription = widget.data.listen(_onData);
  }
  ...
  void didChange(String? value) {
    ...
    widget.data.value = _effectiveController.text;
  }
  ...
  void reset() {
    ...
    _effectiveController.text = widget.initialValue ?? widget.data.value;
    super.reset();
  }
